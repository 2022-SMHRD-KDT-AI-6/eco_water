...
public class DamDataDTO {
    ...
    public DamDataDTO(String D_height, String D_length, String D_altitude, String D_volume, String D_dArea, String D_supArea,
                      String D_area, String D_FWL, String D_NWL, String D_LWL, String D_mAltitude, String D_lowLevelWater, String D_tSupArea, String D_valVol) {
